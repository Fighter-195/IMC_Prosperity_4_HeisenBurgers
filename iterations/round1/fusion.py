...
# =========================================================================
HYPERPARAMETERS = {
    "EMERALDS_PANIC_THRESHOLD": int(os.getenv("EMERALDS_PANIC_THRESHOLD", "60")),  
    "TOMATOES_PHI1": float(os.getenv("TOMATOES_PHI1", "-0.35")), 
    "TOMATOES_PHI2": float(os.getenv("TOMATOES_PHI2", "0.3")),  
    "TOMATOES_SKEW_DIVISOR": float(os.getenv("TOMATOES_SKEW_DIVISOR", "30.0")),   
    "TOMATOES_SKEW_POWER": float(os.getenv("TOMATOES_SKEW_POWER", "2.5")), 
}
    ...
    def execution_engine(self, state: TradingState, market_regime: str) -> Dict[str, List[Order]]:
        ...
        for product in state.order_depths.keys():
            ...
            # =================================================================
                ...
                # Apply the dynamic power and divisor from the sweep
